...
const items = verificationQueue.filter((v) => v.track === "agent");

export default function AgentVerificationsPage() {
  return (
    <>
      <PageHeader title="Agent verifications" description="License + CAC + identity. The bar stays high." />
      <div className="px-6 lg:px-8 py-8 space-y-8">
        <PillTabs
          ...
          items={[
            ...
            { href: "/admin/verifications/agents", label: "Agents", count: items.length },
