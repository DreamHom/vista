...
import { conversations, agents, applicants, owners } from "@/lib/mock-data";
import { formatRelativeTime } from "@/lib/utils";

export const metadata: Metadata = { title: "Agent · messages" };
...
export default function AgentMessagesPage() {
  return (
    <>
      <PageHeader title="Messages" description="Owners and applicants. One inbox. Full history kept." />
        ...
        <Card>
          ...
          <CardBody className="p-0">
            <ul className="divide-y divide-border">
              {conversations.map((c) => {
                const partner = c.participantIds.find((p) => p !== me.id) ?? c.participantIds[0];
                return (
