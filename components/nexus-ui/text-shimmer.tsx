...
/**
 * TextShimmer: Nexus UI port.
 * Source: https://nexus-ui.dev/docs/components/text-shimmer
 *
 * Uses CSS `oklch(from currentColor …)` relative color syntax, which is
 * available in Chrome 119+, Safari 16.4+, Firefox 128+. Older browsers
 * gracefully degrade to flat text (the gradient renders as currentColor).
 *
 * Tailwind v4 ships `bg-size-*` utilities natively; on our v3 setup we use
 * inline `backgroundSize` instead.
 */
